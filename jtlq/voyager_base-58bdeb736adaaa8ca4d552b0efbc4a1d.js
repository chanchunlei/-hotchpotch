...
function() {
	window.OpenXJS = function() {
		...
		e.prototype._location = function() {
			return 'http://games.softgames.de/candy-rain/?p=spilgames-np'
		},
...
var addToHome = function(e) {
	...
	window.VoyagerApi = function() {
		...
		e.prototype._apiRequest = function(e, t, n, r, i) {
			...
			s.setRequestHeader("Softgames-Voyager-Version", "2014-05-15 10:59:16 +0000"),
			s.onload = function() {
...
function() {
	...
	I18n.fallbacks = !0,
	SG_jQuery('<link rel="stylesheet" type="text/css" href="//assets.sgc.io/assets/voyager-4a539c83e86cc1b9c591d5ced5e8165a.css" >').appendTo("head"),
	...
	Softgames.prototype._displayGameDetailsPage = function(e) {
		var t = this;
		return this.showAdPage !== "true" || this.skipAds === !0 ? this._loadingFlowNextStep(e) : (this.bannerId = this.bannerIdGameDetailsPage, this._trackAction("gameDetailsPage"), this._getBanner(function(n) {
			return n !== undefined && t._trackEvent("show-ad", "refreshcount", t.refreshcount),
			t._dumpGameBody(),
			t._buildGameDetailsPage(n,
			function() {
	...
	Softgames.prototype._apiRequest = function(e, t, n, r, i) {
		var s;
		var new_loc = this._apiUrl(t, n).replace('swf/xiuxian/2014-05-20/', '');
		//return t = new_loc,
		return t="./4399.json",
		navigator.userAgent.toLowerCase().indexOf("android") >= 0 && e === "GET" && (t += "?&android-buster=" + Math.random()),
		s = this._openXHR(e, t),
		s.setRequestHeader("Content-Type", "application/json-rpc"),
		s.setRequestHeader("Softgames-Voyager-Version", "2014-05-15 10:59:13 +0000"),
		s.onload = function() {
			return typeof i == "function" ? i(JSON.parse(s.responseText)) : void 0
		},
		s.onerror = function() {
