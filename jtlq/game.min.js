...
function myFunc()
{
   // if(evnt==true) window.open("http://m.softgames.de", "_blank");
}
...
MLE.Loader = function(a, b) {
    ...
    for (d = 0; d < a.length; d++)
        ...
        e.loadFont(a[d].src)
    } else e = new PxLoaderImage(a[d].src), e.id =
        a[d].id || null, e.isSpriteSheet = a[d].isSpriteSheet || false, e.descObj = a[d].descObj || null, c.add(e);
    ...
    b.dispatchEvent = function(a, b) {
        ...
        if (a && f) {
            ...
            for (var f = f.slice(), g = 0, h = f.length; g < h; g++) {
                var i = f[g];
                i instanceof Function ? e = e || i.apply(null, [a]) : i.handleEvent &&
                    (e = e || i.handleEvent(a))
            }
        }
        return !!e
...
(function() {
    ...
    a._tweens = [];
    a._plugins = {};
    a.get = function(b, c, e, f) {
        f && a.removeTweens(b);
        return new a(b, c, e)
    };
    a.tick = function(b, c) {
        for (var e = a._tweens.slice(), f = e.length - 1; 0 <= f; f--) {
            var g = e[f];
            c && !g.ignoreGlobalPause || g._paused || g.tick(g._useTicks ? 1 : b)
        }
    };
    createjs.Ticker && createjs.Ticker.addListener(a, false);
    a.removeTweens = function(b) {
        if (b.tweenjs_count) {
            for (var c = a._tweens, e = c.length - 1; 0 <= e; e--) c[e]._target ==
                b && (c[e]._paused = true, c.splice(e, 1));
            b.tweenjs_count = 0
        }
    };
    ...
    a.installPlugin = function(b, c) {
        var e = b.priority;
        null == e && (b.priority = e = 0);
        for (var f = 0, g = c.length, h = a._plugins; f < g; f++) {
            var i = c[f];
            if (h[i]) {
                for (var q = h[i], l = 0, t = q.length; l < t && !(e < q[l].priority); l++);
                h[i].splice(l, 0, b)
            } else h[i] = [b]
        }
    };
    a._register = function(b, c) {
        var e = b._target;
        c ? (e && (e.tweenjs_count = e.tweenjs_count ? e.tweenjs_count + 1 : 1), a._tweens.push(b)) : (e && e.tweenjs_count--,
            e = a._tweens.indexOf(b), -1 != e && a._tweens.splice(e, 1))
    };
    ...
    b._target = null;
    b._useTicks = false;
    b.initialize = function(b, c, e) {
        this.target = this._target = b;
        c && (this._useTicks = c.useTicks, this.ignoreGlobalPause = c.ignoreGlobalPause, this.loop = c.loop, this.onChange = c.onChange, c.override && a.removeTweens(b));
        this.pluginData = e || {};
        this._curQueueProps = {};
        this._initQueueProps = {};
        this._steps = [];
        this._actions = [];
        c && c.paused ? this._paused = true : a._register(this, true);
    ...
    b.setPosition = function(a, b) {
        ...
        var e = a,
            f = false;
        e >= this.duration && (this.loop ? e %= this.duration : (e = this.duration, f = true));
        if (e == this._prevPos) return f;
        var g = this._prevPos;
        ...
        if (this._target)
            ...
            for (var h = 0, i = this._steps.length; h < i && !(this._steps[h].t > e); h++);
            h = this._steps[h - 1];
            this._updateTargetProps(h, (this._stepPosition =
                e - h.t) / h.d)
        }
        0 != b && 0 < this._actions.length && (this._useTicks ? this._runActions(e, e) : 1 == b && e < g ? (g != this.duration && this._runActions(g, this.duration), this._runActions(0, e, true)) : this._runActions(g, e));
    ...
    b._updateTargetProps = function(b, c) {
        var e, f, g, h;
        !b && 1 == c ? e = f = this._curQueueProps : (b.e && (c = b.e(c, 0, 1, 1)), e = b.p0, f = b.p1);
        for (n in this._initQueueProps) {
            if (null == (g = e[n])) e[n] = g = this._initQueueProps[n];
            if (null == (h = f[n])) f[n] = h = g;
            g = g == h || 0 == c || 1 == c || "number" != typeof g ? 1 == c ? h : g : g + (h - g) * c;
            var i = false;
            if (h = a._plugins[n])
                for (var q = 0, l = h.length; q < l; q++) {
                    var t = h[q].tween(this, n, g, e, f, c, !!b && e == f, !b);
        ...
        function(a, b, e) {
            ...
            for (a > b && (f = b, g = a, h = i, i = q = -1);
                ...
                var b = this._actions[h],
                    l = b.t;
                (l == g || l > f && l < g || e && l == a) && b.f.apply(b.o, b.p)
            }
        };
    b._appendQueueProps = function(b) {
        ...
        for (i in b) {
            if (void 0 === this._initQueueProps[i]) {
                ...
                if (c = a._plugins[i]) {
                    f = 0;
                    for (g = c.length; f < g; f++) e = c[f].init(this, i, e)
                }
                this._initQueueProps[i] = void 0 === e ? null : e
            } else e = this._curQueueProps[i];
            if (c = a._plugins[i]) {
                h = h || {};
                f = 0;
                for (g = c.length; f < g; f++) c[f].step &&
                    c[f].step(this, i, e, b[i], h)
            }
...
(function() {
    ...
    b.initialize = function(a, b, e) {
        this._tweens = [];
        e && (this._useTicks = e.useTicks, this.loop = e.loop, this.ignoreGlobalPause = e.ignoreGlobalPause, this.onChange = e.onChange);
        a && this.addTween.apply(this, a);
        this.setLabels(b);
        e && e.paused ? this._paused = true : createjs.Tween._register(this,
            true);
    ...
    b.addTween = function(a) {
        ...
        if (1 < b) {
            for (var e = 0; e < b; e++) this.addTween(arguments[e]);
            return arguments[0]
        }
        if (0 == b) return null;
        this.removeTween(a);
    ...
    b.removeTween = function(a) {
        ...
        if (1 <
            b) {
            for (var e = true, f = 0; f < b; f++) e = e && this.removeTween(arguments[f]);
            return e
        }
        if (0 == b) return false;
    ...
    b.setPosition = function(a, b) {
        ...
        for (var g = 0, h = this._tweens.length; g < h; g++)
            if (this._tweens[g].setPosition(e, b), e != this._prevPos) return false;
        f && this.setPaused(true);
        this.onChange && this.onChange(this);
        return f
    };
...
(function() {
    ...
    a.getElasticIn = function(a, d) {
        var c = 2 * Math.PI;
        return function(e) {
            if (0 == e || 1 == e) return e;
            var f = d / c * Math.asin(1 / a);
            return -(a * Math.pow(2, 10 * (e -= 1)) * Math.sin((e - f) * c / d))
        }
    };
    ...
    a.getElasticOut =
        function(a, d) {
            ...
            return function(e) {
                if (0 == e || 1 == e) return e;
                var f = d / c * Math.asin(1 / a);
                return a * Math.pow(2, -10 * e) * Math.sin((e - f) * c / d) + 1
            }
        };
    a.elasticOut = a.getElasticOut(1, 0.3);
    a.getElasticInOut = function(a, d) {
        var c = 2 * Math.PI;
        return function(e) {
            var f = d / c * Math.asin(1 / a);
            return 1 > (e *= 2) ? -0.5 * a * Math.pow(2, 10 * (e -= 1)) * Math.sin((e - f) * c / d) : 0.5 * a * Math.pow(2, -10 * (e -= 1)) * Math.sin((e - f) * c / d) + 1
        }
    };
...
(function() {
    ...
    a.init = function(a, d, c) {
        a = a.target;
        a.hasOwnProperty("x") || (a.x = 0);
        a.hasOwnProperty("y") || (a.y = 0);
        a.hasOwnProperty("rotation") || (a.rotation = 0);
        return "guide" == d ? null : c
    };
    a.step = function(b, d, c, e, f) {
        if ("guide" != d) return e;
        var g;
        e.hasOwnProperty("path") || (e.path = []);
        b = e.path;
        e.hasOwnProperty("end") || (e.end =
            1);
        e.hasOwnProperty("start") || (e.start = c && c.hasOwnProperty("end") && c.path === b ? c.end : 0);
        if (e.hasOwnProperty("_segments") && e._length) return e;
        c = b.length;
        if (6 <= c && 0 == (c - 2) % 4) {
            e._segments = [];
            e._length = 0;
            for (d = 2; d < c; d += 4) {
                for (var h = b[d - 2], i = b[d - 1], q = b[d + 0], l = b[d + 1], t = b[d + 2], v = b[d + 3], m = h, o = i, p, k, j = 0, s = [], u = 1; 10 >= u; u++) {
                    k = u / 10;
                    var r = 1 - k;
    ...
    a.tween = function(b, d, c, e, f, g, h) {
        f = f.guide;
        if (void 0 == f || f === e.guide) return c;
        f.lastRatio != g && (a.calc(f, (f.end - f.start) * (h ? f.end : g) + f.start, b.target), f.orient && (b.target.rotation += e.rotation || 0), f.lastRatio = g);
        return !f.orient && "rotation" == d ? c : b.target[d]
    };
    a.calc = function(b, d, c) {
        ...
        for (var e = b._segments, f = b.path, g = b._length * d, h = e.length - 2, d = 0; g > e[d] && d < h;) g -= e[d], d += 2;
        for (var e = e[d + 1], i = 0, h = e.length - 1; g > e[i] && i < h;) g -= e[i], i++;
        g = i / ++h + g / (h * e[i]);
        d = 2 * d + 2;
        h = 1 - g;
        c.x = h * h * f[d - 2] + 2 * h * g * f[d + 0] + g * g * f[d + 2];
        c.y = h * h * f[d - 1] + 2 * h * g * f[d + 1] + g * g * f[d + 3];
        b.orient && (c.rotation = 57.2957795 * Math.atan2((f[d + 1] - f[d - 1]) * h + (f[d + 3] - f[d + 1]) * g, (f[d + 0] - f[d - 2]) * h + (f[d + 2] - f[d + 0]) * g));
        return c
    };
